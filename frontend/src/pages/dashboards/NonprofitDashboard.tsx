...
const NonprofitDashboard: React.FC = () => {
            ...
            <div className="flex flex-1">
                ...
                <main className="flex-1 p-8 bg-gray-100">
                    <div className="bg-white rounded-2xl shadow-lg p-6 animate-fadeIn">
                        <h2 className="text-2xl font-bold mb-4">Welcome, {user.name || 'Nonprofit Admin'}!</h2>
                        <p className="mb-4">This is your Nonprofit Organization Dashboard.</p>
                        <ul className="list-disc list-inside space-y-2">
                            <li>Post new volunteering opportunities</li>
                            <li>Manage volunteers and events</li>
